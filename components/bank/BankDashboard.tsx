        ...
        <div className="p-6 space-y-8">
            ...
            <div className="grid grid-cols-2 gap-3">
                ...
                >
                    ...
                    <span className="text-xs font-bold text-slate-700">Feed</span>
                ...
                >
                    ...
                    <span className="text-xs font-bold text-slate-700">Invite Visitor</span>
...
Wishlist
            ...
            <div className="pt-4 border-t border-slate-100">
                <div className="flex justify-between items-center bg-slate-50 p-3 rounded-xl border border-slate-100">
                    <span className="text-xs font-bold text-slate-500">Daily Budget</span>
                ...
                <p className="text-[9px] text-slate-400 mt-2 text-center">
                    Yesterday's leftover budget converts into today's Action Points (AP).
                </p>
            </div>
